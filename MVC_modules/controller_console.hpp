...
namespace controller {
	...
	public:
		...
		virtual std::vector<std::string> read_level_define_data() const 	override;
		virtual std::vector<std::string> read_room_define_data() const 		override;
		virtual std::vector<std::string> read_roomtype_define_data() const 	override;
		virtual std::vector<std::string> read_wall_define_data() const 		override;
		virtual std::vector<std::string> read_npc_define_data() const 		override;
		virtual std::vector<std::string> read_npctype_define_data() const 	override;
		virtual std::vector<std::string> read_item_define_data() const 		override;
		virtual std::vector<std::string> read_itemtype_define_data() const 	override;
		virtual std::vector<std::string> read_buff_define_data() const 		override;
		virtual std::vector<std::string> read_bufftype_define_data() const 	override;
	};
}
